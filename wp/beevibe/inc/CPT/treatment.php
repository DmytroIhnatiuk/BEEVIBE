...
function register_treatment_tags_taxonomy()
{
    register_taxonomy('treatment_tag', ['post', 'clinics'], [ // null - таксономия сама по себе, без привязки к постам
        'label' => __('Теги услуг', 'globalmedic'),
        'rewrite' => ['slug' => 'treatment-tag'],
        'hierarchical' => true, // Нехиерархическая (как стандартные теги)
...
add_action('init', 'register_treatment_tags_taxonomy');
